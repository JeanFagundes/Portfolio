...
import bank_app from 'assets/bankWallpaper.jpg';
import movie_theater from 'assets/movieTheater.jpg';
    ...
    const projects = [
        {
            ...
            github: 'https://github.com/JeanFagundes/Bank_APP',
            page: 'https://bank-app-jeanfagundes.vercel.app',
        },
        {
            id: 2,
            title: 'Movie Theater',
            imageUrl: movie_theater,
            description:
            ...
            github: 'https://github.com/JeanFagundes/movie_theater',
            page: 'https://movie-theater-six.vercel.app',
        },
        {
            id: 3,
            title: 'Automações',
